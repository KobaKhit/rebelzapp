                ...
                <div className="flex">
                  ...
                  <div className="ml-3">
                    <p className="text-sm text-yellow-700">
                      <strong>AG-UI Mode:</strong> This feature requires the backend SSE endpoint to be deployed. 
                      You may see connection errors until deployment is complete. 
                      <button 
                        onClick={() => setUseAGUI(false)}
                        className="underline ml-2 font-medium hover:text-yellow-800"
                      >
